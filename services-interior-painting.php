...
<main class="rpc-service-page bg-[#f6f5f0] text-[#192F44] overflow-hidden">
  ...
  <?php
    $hero_image = 'http://real-painting-corp.local/wp-content/uploads/2026/04/InteriorPaintingService.jpg-scaled.jpeg';
    ...
    <div class="relative mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div class="lg:max-w-xl">
        ...
        <p class="ajs-reveal-up mt-6 max-w-3xl text-base leading-8 text-[#192F44]/80">
          Let’s talk about the rooms you want to refresh, the finish you want to achieve, and the level of care your home deserves from start to finish.
        </p>

        <p class="ajs-reveal-up mt-6 max-w-2xl text-sm leading-7 text-[#192F44]/68">
          Request your free estimate and we’ll help you define scope, timeline, and next steps with clarity.
        </p>
        ...
        <form class="rpc-estimate-form rpc-estimate-form--light" method="post" action="#">
          ...
          <div class="rpc-estimate-form__grid">
            ...
            <div class="rpc-estimate-form__field rpc-estimate-form__field--full">
              ...
              <textarea id="rpc-service-message" name="message" rows="4" placeholder="Scope, timing, rooms involved, or anything else we should know."></textarea>
            </div>
          </div>
