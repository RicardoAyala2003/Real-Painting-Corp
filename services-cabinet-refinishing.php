<?php
/**
 * Template Name: Service - Cabinet Refinishing & Staining
 *
 * Cabinet Refinishing & Staining page for Real Painting Corp
...
<main class="rpc-service-page bg-[#f6f5f0] text-[#192F44] overflow-hidden">
  ...
  <?php
    $hero_image = 'http://real-painting-corp.local/wp-content/uploads/2026/04/CabinetRefinishingStainingService.jpg-scaled.jpeg';
    ...
    $included_items = [
      ...
      'Complete kitchen protection and daily cleanup',
    ];
      ...
      <div class="relative overflow-hidden border border-[#192F44]/10 bg-white shadow-[0_24px_60px_rgba(25,47,68,0.12)]">
        ...
        <div class="relative h-[520px] overflow-hidden lg:h-[620px]">
          <img
            ...
            alt="Cabinet refinishing and staining project"
        ...
        <div class="ajs-reveal-right">
          <div class="relative overflow-hidden border border-[#192F44]/10 bg-[#fcfbf8] p-6 shadow-[0_20px_44px_rgba(25,47,68,0.08)] md:p-8 lg:p-10">
            ...
            <div class="space-y-6 text-base leading-8 text-[#192F44]/80">
              ...
              <p>
                We handle the complete process: cleaning, deglossing, sanding, priming, and applying professional-grade finishes. Whether you want a modern painted look or a rich stain, we deliver a result that feels like a new kitchen.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="ajs-reveal-up max-w-3xl">
        ...
        <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] text-[#192F44] md:text-5xl">
          Every phase handled with preparation and protection.
        </h2>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div class="ajs-reveal-left">
          ...
          <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
            This is for homeowners who want a dramatic kitchen refresh without a full replacement.
          </h2>
        </div>

        <div class="ajs-reveal-right space-y-6 text-base leading-8 text-white/82">
          <p>
            Cabinet refinishing is ideal for homeowners who like the layout they already have but want the room to feel cleaner, brighter, and more current. The impact is immediate, but the disruption is significantly lower than a full remodel.
          </p>

          <p>
            The difference comes down to preparation, finish quality, and protecting the kitchen while the work is underway. That’s where our process matters most.
          </p>
        </div>
      </div>
    </div>
        ...
        <form class="rpc-estimate-form rpc-estimate-form--light" method="post" action="#">
          ...
          <div class="rpc-estimate-form__grid">
            ...
            <div class="rpc-estimate-form__field rpc-estimate-form__field--full">
              ...
              <textarea id="rpc-service-message" name="message" rows="4" placeholder="Scope, finish preference, timing, or anything else we should know."></textarea>
            </div>
          </div>
