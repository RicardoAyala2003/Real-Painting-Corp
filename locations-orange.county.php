<?php
/**
 * Template Name: Location - Orange County
 *
 * Orange County location page for Real Painting Corp
      ...
      <div class="relative overflow-hidden border border-[#192F44]/10 bg-white shadow-[0_24px_60px_rgba(25,47,68,0.12)]">
        ...
        <div class="relative h-[520px] overflow-hidden lg:h-[620px]">
          <img
            ...
            class="rpc-location-hero-photo h-full w-full object-cover"
          >
        ...
        <div class="absolute inset-x-0 bottom-0 top-0 flex items-center">
          <div class="mx-auto w-full max-w-7xl px-4">
            <div class="ajs-reveal-left max-w-2xl border border-white/12 bg-[#192F44]/82 p-7 text-white shadow-[0_18px_40px_rgba(25,47,68,0.24)] backdrop-blur-sm md:p-9">
              ...
              <div class="mt-8">
                <a href="/contact-us"
                   class="rpc-location-btn rpc-location-btn-green inline-flex items-center justify-center px-8 py-4 text-sm font-black uppercase tracking-[0.14em] text-white">
      ...
      <div class="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        <?php foreach ($counties as $county) : ?>
          <article class="ajs-reveal-stagger group relative overflow-hidden border border-[#192F44]/10 bg-white p-6 shadow-[0_16px_34px_rgba(25,47,68,0.06)]">
            ...
            <h3 class="mt-2 text-xl font-black tracking-[-0.03em] text-[#192F44]">
  ...
  <section class="relative isolate overflow-hidden bg-white py-20 text-[#192F44] lg:py-24 border-t border-[#192F44]/10">
    ...
    <div class="relative mx-auto max-w-5xl px-4 text-center">
      ...
      <div class="ajs-reveal-up mt-8 flex flex-wrap items-center justify-center gap-3">
        <a href="/contact-us"
           class="rpc-location-btn rpc-location-btn-green inline-flex items-center justify-center px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-white">
          Request a Free Estimate
        </a>

        <a href="tel:+19092326602"
           class="rpc-location-btn rpc-location-btn-dark inline-flex items-center justify-center px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-white">
          (909) 232-6602
        </a>
      </div>

      <div class="rpc-location-swipe rpc-location-swipe-light mx-auto mt-10 max-w-2xl"></div>
    </div>
  </section>
</main>
...
<style>
  ...
  .rpc-location-page h1,
  .rpc-location-page h2,
  .rpc-location-page h3 {
    font-family: "Space Grotesk", "Segoe UI", Arial, sans-serif;
  }

  .rpc-location-hero-photo {
    animation: rpcLocationHeroZoom 14s ease-out forwards;
  ...
  .rpc-location-btn:hover::after {
    transform: translateX(110%);
  }

  .rpc-location-btn:hover {
    transform: translateY(-2px);
  }

  .rpc-location-btn-dark {
    background: #192F44;
    border-color: #192F44;
    box-shadow: 0 16px 34px rgba(25,47,68,0.18);
  }

  .rpc-location-btn-dark:hover {
    background: #236476;
    border-color: #236476;
  }

  .rpc-location-btn-green {
    background: #7DAD3F;
    border-color: #7DAD3F;
    box-shadow: 0 16px 34px rgba(125,173,63,0.22);
  }

  .rpc-location-btn-green:hover {
    background: #4A6C2F;
    border-color: #4A6C2F;
  }
  ...
  .rpc-location-swipe {
    ...
    opacity: 0.92;
    animation: rpcLocationSwipeShift 7s ease-in-out infinite alternate;
  }

  .rpc-location-swipe-light {
  ...
  @keyframes rpcLocationSwipeShift {
    0%   { transform: translateX(0) scaleX(1); }
    100% { transform: translateX(6px) scaleX(1.01); }
  }

  @keyframes rpcLocationHeroZoom {
