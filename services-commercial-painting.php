<?php
/**
 * Template Name: Service - Commercial Painting
 *
 * Commercial Painting page for Real Painting Corp
...
<main class="rpc-service-page bg-[#f6f5f0] text-[#192F44] overflow-hidden">
  ...
  <?php
    $hero_image = 'http://real-painting-corp.local/wp-content/uploads/2026/04/CommercialPaintingService.jpg-scaled.jpeg';

    $offer_items = [
      'Interior and exterior commercial repainting',
      'Office, retail, medical, and multi-use spaces',
      'Off-hours and weekend scheduling available',
      'Surface preparation, repair, and priming included',
        ...
        <div class="ajs-reveal-left">
          <div class="sticky top-28">
            ...
            <h2 class="mt-5 max-w-[10ch] text-3xl font-black leading-[0.94] tracking-[-0.05em] text-[#192F44] md:text-5xl">
              A refreshed commercial space changes how your business is perceived.
            </h2>
        ...
        <div class="ajs-reveal-right">
          <div class="relative overflow-hidden border border-[#192F44]/10 bg-[#fcfbf8] p-6 shadow-[0_20px_44px_rgba(25,47,68,0.08)] md:p-8 lg:p-10">
            ...
            <div class="space-y-6 text-base leading-8 text-[#192F44]/80">
              <p>
                The condition of your commercial space communicates something to every client, customer, and employee who walks through the door. Peeling walls and faded surfaces send the wrong message.
              </p>

              <p>
                Real Painting provides selective commercial repaint services for businesses that value quality over volume. We schedule around your operations, work efficiently, and deliver a result that elevates how your business presents itself.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="ajs-reveal-up max-w-3xl">
        ...
        <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] text-[#192F44] md:text-5xl">
          Commercial repainting executed with minimal disruption.
        </h2>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div class="ajs-reveal-left">
          ...
          <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
            This is for businesses that understand presentation, timing, and professionalism all matter.
          </h2>
        </div>

        <div class="ajs-reveal-right space-y-6 text-base leading-8 text-white/82">
          <p>
            Commercial repainting is about more than fresh walls. It affects the way customers experience your space, how employees feel in it, and how professionally your business presents itself from the first impression forward.
          </p>

          <p>
            That’s why our process is built around efficiency, minimal disruption, and a result that improves perception without interrupting operations more than necessary.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="relative mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div class="lg:max-w-xl">
        <h2 class="ajs-reveal-up text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
          Need a Commercial Space Refreshed?
        </h2>

        <p class="ajs-reveal-up mt-6 max-w-3xl text-base leading-8 text-[#192F44]/80">
          Let’s talk about your space, the scheduling constraints you’re working around, and the result you want clients, customers, and employees to experience.
        </p>
        ...
        <form class="rpc-estimate-form rpc-estimate-form--light" method="post" action="#">
          ...
          <div class="rpc-estimate-form__grid">
            ...
            <div class="rpc-estimate-form__field rpc-estimate-form__field--full">
              ...
              <textarea id="rpc-service-message" name="message" rows="4" placeholder="Property type, scheduling needs, scope, or anything else we should know."></textarea>
            </div>
          </div>
