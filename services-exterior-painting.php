...
<main class="rpc-service-page bg-[#f6f5f0] text-[#192F44] overflow-hidden">
  ...
  <?php
    $hero_image = 'http://real-painting-corp.local/wp-content/uploads/2026/04/ExteriorPaintingService.jpg-scaled.jpeg';
      ...
      <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div class="ajs-reveal-left">
          ...
          <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
            This is for homeowners who want protection that performs and curb appeal that lasts.
          </h2>
        </div>

        <div class="ajs-reveal-right space-y-6 text-base leading-8 text-white/82">
          <p>
            Exterior painting isn’t just about appearance. It’s about defending the home against sun, wind, moisture, and wear while keeping the property looking sharp from the street.
          </p>

          <p>
            That’s why the process matters. Preparation, material selection, and clean execution determine whether the finish looks good briefly or performs for years.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="relative mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div class="lg:max-w-xl">
        ...
        <p class="ajs-reveal-up mt-6 max-w-3xl text-base leading-8 text-[#192F44]/80">
          Let’s talk about the condition of your exterior, the coatings your home needs, and the level of protection and curb appeal you want to achieve.
        </p>
        ...
        <form class="rpc-estimate-form rpc-estimate-form--light" method="post" action="#">
          ...
          <div class="rpc-estimate-form__grid">
            ...
            <div class="rpc-estimate-form__field rpc-estimate-form__field--full">
              ...
              <textarea id="rpc-service-message" name="message" rows="4" placeholder="Scope, condition of the exterior, timing, or anything else we should know."></textarea>
            </div>
          </div>
