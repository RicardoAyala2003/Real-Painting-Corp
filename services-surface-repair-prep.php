<?php
/**
 * Template Name: Service - Surface Repair & Preparation
 *
 * Surface Repair & Preparation page for Real Painting Corp
...
<main class="rpc-service-page bg-[#f6f5f0] text-[#192F44] overflow-hidden">
  ...
  <?php
    ...
    $services = [
      ...
      [
        'title' => 'Stucco Repair',
        'copy'  => 'Cracks, chips, and damaged sections repaired with proper technique and matching texture.',
      ],
      [
      ...
      [
        ...
        'copy'  => 'Popcorn ceiling removal with proper containment, repair, and finishing for a clean, modern look.',
      ],
      [
        'title' => 'Baseboards & Molding',
        'copy'  => 'Installation, replacement, and painting of baseboards, crown molding, and trim.',
      ],
      [
        'title' => 'Doors & Windows',
        'copy'  => 'Removal, installation, and finishing of interior and exterior doors and windows.',
      ],
      [
        'title' => 'Flooring',
        'copy'  => 'Removal and installation of flooring as part of interior remodeling projects.',
      ],
    ];
      ...
      <div class="relative overflow-hidden border border-[#192F44]/10 bg-white shadow-[0_24px_60px_rgba(25,47,68,0.12)]">
        ...
        <div class="relative h-[520px] overflow-hidden lg:h-[620px]">
          <img
            ...
            alt="Surface repair and preparation project"
        ...
        <div class="ajs-reveal-left">
          <div class="sticky top-28">
            ...
            <h2 class="mt-5 max-w-[10ch] text-3xl font-black leading-[0.94] tracking-[-0.05em] text-[#192F44] md:text-5xl">
              Every lasting finish starts with the surface underneath.
            </h2>
        ...
        <div class="ajs-reveal-right">
          <div class="relative overflow-hidden border border-[#192F44]/10 bg-[#fcfbf8] p-6 shadow-[0_20px_44px_rgba(25,47,68,0.08)] md:p-8 lg:p-10">
            ...
            <div class="space-y-6 text-base leading-8 text-[#192F44]/80">
              <p>
                A paint job is only as good as the surface underneath. Cracks, holes, uneven texture, and damaged stucco don’t disappear under a coat of paint. They show through. Every time.
              </p>

              <p>
                We take surface preparation seriously because it’s the step that determines whether your result lasts 2 years or 10. It’s also the step most contractors skip to save time. We don’t.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="ajs-reveal-up max-w-3xl">
        ...
        <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] text-[#192F44] md:text-5xl">
          Structural prep and finish-ready repair.
        </h2>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div class="ajs-reveal-left">
          ...
          <h2 class="mt-5 text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
            This is for homeowners who understand that finish quality starts long before the paint goes on.
          </h2>
        </div>

        <div class="ajs-reveal-right space-y-6 text-base leading-8 text-white/82">
          <p>
            Surface repair is where shortcuts become visible. Cracks, failed patches, uneven texture, and poor prep don’t stay hidden. They show up in the final result and shorten how long that result lasts.
          </p>

          <p>
            That’s why this work matters so much. It creates the clean, stable base that every repaint or remodel depends on.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="relative mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div class="lg:max-w-xl">
        <h2 class="ajs-reveal-up text-3xl font-black leading-tight tracking-[-0.05em] md:text-5xl">
          Need Surface Work Before a Repaint or Remodel?
        </h2>
        ...
        <form id="rpc-service-estimate-form" class="rpc-estimate-form rpc-estimate-form--light" method="post" action="#">
          ...
          <div class="rpc-estimate-form__grid">
            ...
            <div class="rpc-estimate-form__field rpc-estimate-form__field--full">
              ...
              <textarea id="rpc-service-message" name="message" rows="4" placeholder="Damage, repair scope, prep needs, or anything else we should know."></textarea>
            </div>
          </div>
